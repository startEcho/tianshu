...
/**
 * Intentionally vulnerable deserialization controller for lab use.
 */
@RestController
public class DeserializationController {
    ...
    /**
     * Demonstrates insecure Java native deserialization.
     *
     * <p>This endpoint intentionally deserializes untrusted input to reproduce deserialization
     * vulnerability behavior in a controlled lab environment.
     *
     * @param base64Payload Base64-encoded serialized Java object bytes
     * @return success result or root-cause error message
     */
    ...
    public ResponseEntity<String> processSerializedData(@RequestBody String base64Payload) {
        ...
        try {
            ...
            String message = "Object deserialized successfully. Object type: "
